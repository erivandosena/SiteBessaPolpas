<%@ Page Language="C#" MasterPageFile="~/Adm/MasterPageAdm.master" AutoEventWireup="true" CodeFile="CadPagina.aspx.cs" Inherits="Adm_CadPagina" Title="Untitled Page" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h1 class="heading">
        Cadastro de Página</h1>
    <div class="entry">

<p>Código:&nbsp;<asp:Label ID="Label1" runat="server"></asp:Label></p>
    <p>
        <asp:CheckBox ID="CheckBox1" runat="server" Text="Link de página(s) (sem conteúdo)" /></p>
