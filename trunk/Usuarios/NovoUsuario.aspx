<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NovoUsuario.aspx.cs" Inherits="Usuarios_NovoUsuario" %>
...
<body>
    ...
    <asp:CreateUserWizard ID="CreateUserWizard1" runat="server" Font-Names="Verdana"
        ...
        FinishCompleteButtonText="Concluir" FinishPreviousButtonText="" InvalidEmailErrorMessage="igite um endereço de e-mail válido."
        ...
        FinishPreviousButtonImageUrl="Voltar">
        <WizardSteps>
            <asp:CreateUserWizardStep ID="CreateUserWizardStep1" runat="server" 
                Title="1º Passo -  Infomações do usuário">
                <ContentTemplate>
                    <table style="font-size: 10pt; font-family: Verdana" border="0" width="400">
                        ...
                        <tr>
                            <td align="left" colspan="2" style="font-weight: normal; color: #000000; background-color: #FFFFFF">
                            </td>
                        </tr>
                        <tr>
            ...
            <asp:WizardStep runat="server" ID="wsAssignUserToRoles" Title="2º Passo -  Atribuir regras ao usuário"
                ...
                <table>
                    ...
                    <tr>
                        <td align="left" colspan="2" style="font-weight: normal; color: #000000; background-color: #FFFFFF">
                            Selecione uma ou mais regras para o usuário
                        </td>
                    </tr>
                    <tr>
                        <td>
