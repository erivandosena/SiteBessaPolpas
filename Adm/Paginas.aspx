<%@ Page Language="C#" MasterPageFile="~/Adm/MasterPageAdm.master" AutoEventWireup="true" CodeFile="Paginas.aspx.cs" Inherits="Adm_Paginas" Title="Untitled Page" %>
  ...
  <h1 class="heading">
    ...
    <div align="right">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="pag_cod" DataNavigateUrlFormatString="~/Adm/CadPagina.aspx?codpagina={0}"
                    DataTextField="pag_cod" DataTextFormatString="Alterar / Excluir" HeaderText="EDIÇÃO"
                    Text="Alterar/Excluir">
                    <HeaderStyle HorizontalAlign="Left" />
                    <ItemStyle HorizontalAlign="Left" />
                </asp:HyperLinkField>
                <asp:BoundField DataField="pag_nome" HeaderText="TÍTULO">
                    <HeaderStyle HorizontalAlign="Left" />
                </asp:BoundField>
